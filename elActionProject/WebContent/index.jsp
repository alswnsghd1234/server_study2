...
<body>
	...
	<a href="operation.do">02_EL의 연산자</a>
	...
	<!-- 
		*JSP를 이루는 구성인자 
		...
		3  JSP 액션 태그 : XML 기술을 이용해서 기존의 jsp 문법을 확장하는 기술을 제공하는 태그
			-표준 액션 태그 (Standard Action Tag) : JSP 페이지에서 바로 사용 가능(별도의 연동 필요없음)
				ㄴ표준액션태그는 모든 태그명 앞에 jsp: 라는 접두어를 붙인다
			-커스텀 액션 태그 (Custom Action Tag) : JSP 페이지에서 바로 사용 불가능(별도의 연동 필요)
				ㄴ커스텀 액션 태그는 모든 태그명 앞에 jsp: 외의 다른 접두어가 붙는다 
				ㄴ제공되고있는 대표적인 유용한 라이브러리가 있다 (JSTL) 
	 -->
	
	<h1>*JSP Action Tag</h1>
	<p>
		XML기술을 이용해서 기존의 JSP 문법을 확장시키는 기능을 제공하는 태그들
	</p>

	<h3>1.표준 액션 태그</h3>
	<p>
		JSP페이지에서 별도의 라이브러리 연동 없이 곧바로 사용 가능 <br>
		태그앞에 jsp: 라는 접두어가 붙는다.
	</p>	
	...
	<h3>2.커스텀 액션 태그</h3>
	<a href="views/3_customAction/jstl.jsp">JSTL</a> <br>	
