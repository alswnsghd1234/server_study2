...
<body>
	...
	<div id="login_content1">
		...
		<form action="<%=contextPath%>/loginUser.lo" method="post">
		<div id="login_content1_2">
			...
			<button type="button" class="btn btn-danger" onclick="location.href='/Semi/views/member/newMember.jsp'">회원가입</button>
