...
<body>
	...
	<div id="login_content1">
		...
		<form action="<%=contextPath%>/newMemberUser.lo" method="post" id="newMemberUser">
		<div id="login_content1_2">
			<table id="login_table">
				...
				<tr align="center">
				<th colspan="3"><input type="text" id="extraAddress" placeholder="참고항목" class="form-control" name="extraAddress"></th>
				</tr>
				<tr>
