...
public class Member {
	...
	public Member(int i, String string, int j, String string2) {
		
	}
	
	
	
	public Member(String userId, String userPwd, String userName, String userNName, int userBirth, String phone,
