 ...
 * Generated at: 2022-05-13 15:50:35 UTC
...
public final class noticeListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/menubar.jsp", Long.valueOf(1652456993057L));
  }
...
if(loginUser==null) {
      ...
      out.write("        \r\n");
      out.write("        <table align=\"center\" class=\"table-hover\">\r\n");
      out.write("            <thead>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <th width=\"10%\">글번호</th>\r\n");
      out.write("                    <th width=\"50%\">글제목</th>\r\n");
...
for(Notice n : list) {
      ...
      out.write("        </table>\r\n");
      out.write("        <br>\r\n");
      out.write("        <!-- 로그인이 안되어있는 상태일때 getUserId를 먼저해버리면 nullpointerException뜸  \r\n");
      out.write("        	그래서 null인지 아닌지 먼저 비교후 아이디 admin 비교 해야함 -->\r\n");
      out.write("         ");
if(loginUser!=null && loginUser.getUserId().equals("admin")) {
      out.write("\r\n");
      out.write("        <div id=\"writeBtn\"  align=\"center\" >\r\n");
      out.write("            <!--<button class=\"btn btn-info\" onclick=\"location.href=\"\";>글작성</button>  -->\r\n");
      out.write("            <a href=\"");
      out.print(contextPath );
      out.write("/enrollForm.no\" class=\"btn btn-info\">글작성</a>\r\n");
      out.write("        </div>\r\n");
      out.write("        ");
} 
      out.write("\r\n");
      ...
      out.write("        $(function(){\r\n");
      out.write("\r\n");
      out.write("            $(\".table-hover>tbody>tr\").click(function(){\r\n");
      out.write("                // console.log(\"클릭\");\r\n");
      out.write("                //클릭했을때 해당하는 글의 번호를 넘겨줘야 해당 글의 정보를 알수있음(식별자)\r\n");
      out.write("                //해당 tr에 자손 td에 있는 text를 알고싶다\r\n");
      out.write("                var nno = $(this).children().eq(0).text(); //공지사항글 번호\r\n");
      out.write("                // console.log(nno);\r\n");
      out.write("                //요청할 url?키=벨류&키=벨류 ....\r\n");
      out.write("                //물음표 뒤에 오는 내용을 쿼리스트링이라고 한다. ->직접 만들어서 넘겨야함\r\n");
      out.write("\r\n");
      out.write("                // /JSP/detail.no?nno=글번호\r\n");
      out.write("                location.href='");
      out.print(contextPath);
