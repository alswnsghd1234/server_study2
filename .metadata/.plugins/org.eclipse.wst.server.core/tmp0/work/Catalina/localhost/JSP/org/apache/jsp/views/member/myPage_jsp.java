 ...
 * Generated at: 2022-05-16 20:02:48 UTC
...
public final class myPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1652728535431L));
  }
...
if(loginUser==null) {
      ...
      out.write("    <h2 align=\"center\">My Page</h2>\r\n");
      out.write("	<!-- menubar 를 include했기 때문에 contextPath변수를 가져와 사용할 수 있다. -->\r\n");
      ...
      out.write("                <!-- <td><button type=\"button\" onclick=\"\">중복확인</button></td> -->\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td>* 이름</td>\r\n");
      ...
      out.write("                <td>\r\n");
      out.write("                    <!-- (input[type=checkbox name=intrest id= value=]+label)*6 -->\r\n");
      out.write("                    <input type=\"checkbox\" name=\"interest\" id=\"music\" value=\"음악\" >\r\n");
      ...
      out.write("                    <input type=\"checkbox\" name=\"interest\" id=\"coding\" value=\"코딩\">\r\n");
      ...
      out.write("        <script>\r\n");
      out.write("            $(function(){\r\n");
      out.write("                //interest = \"음악,영화\" 또는  \"\"\r\n");
      out.write("                var interest = \"");
      out.print(interest);
      out.write("\";\r\n");
      out.write("\r\n");
      out.write("            // 문자열.search(비교값) : 문자열에서 비교값과 일치하는 값의 시작인덱스 값을 반환 (0부터시작) 없으면 -1 반환\r\n");
      out.write("            $(\"input[type=checkbox]\").each(function(){\r\n");
      out.write("                \r\n");
      out.write("                //순차적으로 접근한 input:chk 요소에 value값이 interest안에 포함되어 있는지 확인\r\n");
      out.write("                // interest문자열안에 체크박스 value값이 포함되어있지 않으면 -1을 반환\r\n");
      ...
      out.write("            <button type=\"submit\" class=\"btn btn-success\">정보 변경</button>\r\n");
      out.write("            <button type=\"button\" class=\"btn btn-warning\" data-toggle=\"modal\" data-target=\"#updatePwdForm\">비밀번호 변경</button>\r\n");
      out.write("            <button type=\"button\" class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#deleteForm\">회원 탈퇴</button>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("    </form>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("					<!-- 회원정보 식별할 회원 아이디도 데이터 보내야함 -->\r\n");
      out.write("					<!-- 굳이 보여줄 필요 없으니 숨겨서 값 넘기기 (hidden) -->\r\n");
      ...
      out.write("                        <td><input type=\"password\" name=\"userPwd\" id=\"enterPwd\" required></td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <td>변경할 비밀번호</td>\r\n");
      out.write("                        <td><input type=\"password\" name=\"updatePwd\" id=\"pwd1\" required></td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <td>변경할 비밀번호 확인</td>\r\n");
      out.write("                        <td><input type=\"password\" name=\"checkPwd\" id=\"pwd2\" required></td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                </table>\r\n");
      out.write("                <br>\r\n");
      out.write("                <button type=\"submit\" class=\"btn btn-dark\" onclick=\"return validatePwd();\">비밀번호 변경</button>\r\n");
      out.write("            </form>\r\n");
      out.write("\r\n");
      out.write("            <script>\r\n");
      out.write("\r\n");
      ...
      out.write("                            alert(\"변경할 비밀번호와 비밀번호 확인이 맞지 않습니다.\");\r\n");
      ...
      out.write("\r\n");
      out.write("		\r\n");
      out.write("		<!-- controller : MemberDeleteController \r\n");
      out.write("			처리메소드명 : deleteMember \r\n");
      out.write("			성공시 = 회원탈퇴 성공 메세지 alert창으로 띄우기 \r\n");
      out.write("			로그아웃 처리 해주기 페이지는 메인 페이지로 이동시키기.\r\n");
      out.write("			\r\n");
      out.write("			실패시 = 에러페이지로 보내서 에러 메세지 띄워주기\r\n");
      out.write("			\r\n");
      out.write("			sql문 = 매핑값 deleteMember \r\n");
      out.write("			delete문 XXX Update문으로 작업 STATUS컬럼 'Y' -> 'N' \r\n");
      out.write("						MODIFY 컬럼 SYSDATE로 작업\r\n");
      out.write("						WHERE절에 USER_ID와 USER_PWD를 검사 \r\n");
      out.write("			\r\n");
      out.write("			MODAL창 사용하기 \r\n");
      out.write("		-->\r\n");
      out.write("		\r\n");
      out.write("		\r\n");
      out.write("		<!-- The Modal -->\r\n");
      ...
      out.write("       	<b>회원 탈퇴 후 복구는 불가능 합니다. <br> 정말로 탈퇴 하시겠습니까? </b> <br><br>\r\n");
      out.write("       <form action=\"");
      out.print(contextPath);
