 ...
 * Generated at: 2022-05-04 02:57:02 UTC
...
if(loginUser==null) {
      ...
      out.write("        <script>\r\n");
      out.write("            $(function(){\r\n");
      out.write("            //interest = \"음악,영화\" / \"\"\r\n");
      out.write("            var interest = \"");
      out.print(interest);
      out.write("\";\r\n");
      out.write("            console.log(interest);\r\n");
      out.write("\r\n");
      out.write("            //문자열.search(비교값) : 문자열에서 비교값과 일치하는 값의 시작인덱스 값을 반환 (0부터 시작) 없으면 -1 반환\r\n");
      out.write("            $(\"input[type=checkbox]\").each(function(){\r\n");
      out.write("                //순차적으로 접근한 input:chk 요소에 value값이 interest안에 포함되어 있는지 확인\r\n");
      out.write("                if(interest.search($(this).val())!=-1){ //interest 문자열안에 체크박스 밸류가 포함되어있지 않으면 -1을 반환\r\n");
      ...
      out.write("            <button type=\"submit\">정보 변경</button>\r\n");
      out.write("            <button type=\"button\">비밀번호 변경</button>\r\n");
